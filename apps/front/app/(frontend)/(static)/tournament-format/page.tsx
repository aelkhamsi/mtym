    ...
    <SectionContainer className='pt-24 pb-20 z-0'>
      ...
      <div className="space-y-6">
        ...
        <p className="text-center">
          Le MTYM se déroule en deux grandes étapes : une <span className="font-semibold">phase de qualification</span> ouverte à tous, suivie d&apos;une <span className="font-semibold">phase finale</span> nationale qui réunit les meilleures équipes sélectionnées sur la base du mérite.
        </p>
        ...
        >
          <div className="w-full space-y-4 p-4">
            ...
            <p>Les participants, regroupés en équipes de 3 à 5 membres, travaillent sur des problèmes de recherche publiés le <span className="font-semibold">30 juin 2026</span>. Ces problèmes demandent de la réflexion, de l&apos;exploration et une vraie démarche scientifique.</p>
        ...
        >
          <div className="w-full space-y-4 p-4">
            ...
            <p>Chaque équipe participe à deux rounds, en présentant, défendant et discutant ses solutions devant un jury et les autres participants.</p>
          </div>
          ...
          <div className="w-full space-y-4 p-4">
            ...
            <p>En parallèle de la compétition, les participants profitent d&apos;un programme riche :</p>
